  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      ...
      .then(
        () => {
          setLoading(false);
          message.success('Thank you for getting in touch. We will get back to you as soon as possible.');
    ...
    <div className="gpt3__header section__padding" id="home">
      <div className="gpt3__header-content">
        ...
        <p>
          ...
          experiences. Join us in harnessing the power of GPT-5 to build a
